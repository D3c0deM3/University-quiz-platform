      ...
      {loading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((subject) => {
            ...
            return isLocked ? (
              <div key={subject.id}>
                <Card className="h-full relative overflow-hidden border-gray-200 opacity-80">
                  <CardContent className="flex flex-col gap-3 p-6">
                    ...
                    <div className="mt-auto pt-1">
                      <Button
                        size="sm"
                        variant="outline"
                        className="w-full border-blue-200 text-blue-600 hover:bg-blue-50 hover:text-blue-700 cursor-pointer"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md rounded-2xl bg-white shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="px-6 py-5">
              <div className="rounded-xl bg-gray-50 border border-gray-100 p-4 text-center mb-5">
                <p className="text-3xl font-bold text-gray-900">$1</p>
                <p className="text-sm text-gray-500 mt-0.5">10,000 UZS &middot; one-time per subject</p>
              </div>
              ...
              {/* Contact */}
              <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-3">Get in touch</p>
              <div className="space-y-2">
                <a
                  href="tel:+998915817711"
                  className="flex items-center gap-3 rounded-lg border border-gray-200 px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                >
