...
export default function AdminQuestionsPage() {
 ...
 {/* Header */}
 <div>
 <h1 className="text-2xl font-bold text-gray-900 dark:text-slate-100">{t('adminQuestions.title')}</h1>
 <p className="text-gray-500 dark:text-slate-400">{t('adminQuestions.subtitle')}</p>
 </div>
 ...
 <HelpCircle size={18} className="text-gray-600 dark:text-slate-400" />
 </div>
 <div>
 <p className="text-xl font-bold text-gray-900 dark:text-slate-100">{counts.total}</p>
 <p className="text-xs text-gray-500 dark:text-slate-400">{t('adminQuestions.total')}</p>
 </div>
 </CardContent>
 </Card>
 <Card>
 ...
 <p className="text-xs text-gray-500 dark:text-slate-400">{t('common.pending')}</p>
 </div>
 </CardContent>
 </Card>
 <Card>
 ...
 <p className="text-xs text-gray-500 dark:text-slate-400">{t('common.approved')}</p>
 </div>
 </CardContent>
 </Card>
 <Card>
 ...
 <p className="text-xs text-gray-500 dark:text-slate-400">{t('common.rejected')}</p>
 </div>
 </CardContent>
 </Card>
 </div>
 ...
 <span className="text-sm text-gray-500 dark:text-slate-400">{t('adminQuestions.questionsCount', { count: total })}</span>
 </div>
 ...
 <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-50 dark:bg-blue-900/20 shrink-0">
 {q.imagePath ? (
 ...
 <div>
 <label className="block text-xs font-medium text-gray-500 dark:text-slate-400 mb-1">{t('adminQuestions.subject')}</label>
 ...
 <div>
 <label className="block text-xs font-medium text-gray-500 dark:text-slate-400 mb-1">{t('adminQuestions.question')}</label>
 <Textarea value={editQuestion} onChange={(e) => setEditQuestion(e.target.value)} rows={2} />
 </div>
 <div>
 <label className="block text-xs font-medium text-gray-500 dark:text-slate-400 mb-1">{t('adminQuestions.answer')}</label>
 ...
 <>
 <p
 className="font-medium text-gray-900 dark:text-slate-100 cursor-pointer"
 ...
 <p className="text-gray-800 dark:text-slate-200 whitespace-pre-wrap">{q.answerText}</p>
 </div>
 {q.imagePath && (
 <div>
 <p className="text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wider mb-1">{t('adminQuestions.image')}</p>
 <img
 ...
 size="sm"
 variant="ghost"
 className="text-gray-500 dark:text-slate-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:text-blue-400"
 onClick={() => startEdit(q)}
 title={t('common.edit')}
 >
 <Pencil size={15} />
 ...
 size="sm"
 variant="ghost"
 className="text-green-600 dark:text-green-400 hover:bg-green-50 dark:hover:bg-green-900/20 hover:text-green-700 dark:text-green-300"
 ...
 size="sm"
 variant="ghost"
 className="text-red-600 dark:text-red-400 hover:bg-red-50 dark:bg-red-900/20 hover:text-red-700"
 ...
 size="sm"
 variant="ghost"
 className="text-gray-400 dark:text-slate-500 hover:bg-red-50 dark:bg-red-900/20 hover:text-red-600 dark:text-red-400"
