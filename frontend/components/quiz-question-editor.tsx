          ...
          {questions.map((q, idx) => (
            <div
              ...
              className={cn(
                ...
                expandedId === q.id ? 'border-blue-200 bg-blue-50/10' : 'border-gray-200 bg-white',
              )}
            >
              {/* Question Header */}
              <div
              ...
              >
                ...
                <span className="text-sm font-bold text-gray-400 shrink-0 w-7">
                  {idx + 1}.
                </span>
          ...
          <div className="space-y-2">
            {question.options.map((opt, idx) => (
              <div key={idx} className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold text-gray-400 shrink-0 w-5">
